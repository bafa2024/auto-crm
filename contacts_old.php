...
if (isset($_GET['action']) && $_GET['action'] === 'download_template') {
    ...
    fputcsv($output, ['226308', 'ROBERT L COSBY TRUCKING LLC', 'ROBERT L COSBY', 'robert@example.com']);
    fputcsv($output, ['123456', 'TEST COMPANY INC', 'JOHN DOE', 'john@example.com']);
    fputcsv($output, ['789012', 'ANOTHER COMPANY LLC', 'JANE SMITH', 'jane@example.com']);
                ...
                if (!is_uploaded_file($file['tmp_name'])) {
                    ...
                    if ($result['success']) {
                        ...
                        if (!empty($result['errors'])) {
                            $message .= "<br><small class='text-muted'>Some rows had issues. Check the file format matches the template.</small>";
                        }
                        $messageType = 'success';
                        error_log("Upload successful: " . $message);
                    } else {
                        $message = 'Upload failed: ' . $result['message'];
                        if (strpos($result['message'], 'Email column not found') !== false) {
                            $message .= '<br><small class="text-muted">Please ensure your file has headers: DOT, Company Name, Customer Name, Email</small>';
                        }
                        $messageType = 'danger';
            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar p-3">
                    <div class="text-center mb-4">
                        <h4><i class="fas fa-users"></i> ACRM</h4>
                        <small>Advanced CRM System</small>
                    </div>
                    ...
                    <div class="text-center">
                        <small>Welcome, <?php echo htmlspecialchars($_SESSION['user_name'] ?? 'User'); ?></small>
                        <br>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>Note:</strong> The first row should contain headers. Supported formats: CSV, Excel (.xlsx, .xls). 
